...
The Karvonen heart rate formula is one method you can use to determine your rate. Create a program that prompts for your age and your resting heart rate. Use the Karvonen formula to determine the target heart rate based on a range of intensities from 55% to 95%.
...
public class App {
    ...
    public static void main(String[] args) {
        int restingPulse = UsrInput.getRestingPulse();
